...
with st.sidebar:
    ...
    st.image("https://www.pngplay.com/wp-content/uploads/12/Anime-Girls-Drawing-Transparent-PNG.png")
...
st.header('Naufal Collection Dashboard :sparkles:')
...
st.caption('Copyright © Naufal 2025')